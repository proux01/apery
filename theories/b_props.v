...
rewrite !addnK; field by rewrite ?pnatr_eq0 -?lt0n ?fact_gt0; lia.
Qed.
...
have {goal_term} -> : goal_term = (-1) ^ (m + 1) * other_term * hardest_term.
  ...
  field by rewrite !intr_eq0 lt0r_neq0 ?binz_gt0; lia.
...
have {hardest_term other_term} -> :
  ...
  by field by rewrite !intr_eq0 lt0r_neq0 ?binz_gt0; lia.
apply/rpredM/rpredX.
